...
# runbooks (no agent frontmatter), not agents. website/ is the Emonphenom HQ
# app (Vite/React), not an agent division. None of these must be scanned as
# source-agent categories.
NON_DIVISION_DIRS=(examples scripts integrations strategy website)
