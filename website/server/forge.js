const niches = [
  ...
  },
  {
    ...
    demand: "High",
    competition: "High",
    angle: "Faceless productized offers for newsletter / Whop sellers",
  },
  {
    key: "students",
...
export function researchNiche({ topic, audience }) {
...
export function buildProduct({ research, productType }) {
...
export function writeSalesPage({ research, product }) {
...
`,
    emails: [
      ...
      {
        subject: `How members get distribution without ads`,
...
export function buildDistribution({ research, product }) {
  const leads = [
    {
    ...
    {
      name: "Whop digital sellers circle",
    ...
    {
      name: "Freelance Twitter/X lists",
      type: "Social list",
      fit: "Medium",
  ...
  return {
    ...
    weeklyPlan: [
      ...
      "Day 3–4: Send 10 partner pitches from Signal list",
...
export function buildLaunchPack({ research, product, sales, distribution }) {
  return {
    checklist: [
